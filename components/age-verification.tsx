      ...
      <div className="w-full max-w-md bg-zinc-900 rounded-2xl p-8 text-center shadow-2xl border border-zinc-800">
        <div className="mb-6">
          ...
          <p className="text-zinc-400 text-sm leading-relaxed">
            This website contains age-restricted content. By entering, you
            confirm that you are at least 18 years old.
          </p>
        </div>

        <div className="bg-zinc-800/50 rounded-xl p-4 mb-6">
          <p className="text-white font-medium">Are you 18 years or older?</p>
        </div>
        ...
        <p className="mt-6 text-xs text-zinc-500">
          By clicking &quot;Yes&quot;, you agree to our Terms of Service and
